...
struct HelpView: View {
    ...
    private let topics: [Topic] = [
        ...
        Topic(symbol: "arrow.uturn.left.circle",
              title: "Letzte Spracheingabe erneut einfügen",
              detail: "War der Fokus beim Loslassen falsch, fügt der globale Kurzbefehl (Standard ⌃⌥⌘V, frei belegbar) die letzte Spracheingabe erneut ins aktive Feld ein."),
