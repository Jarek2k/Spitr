...
UI = collections.OrderedDict([
    ...
    ("Sprachisolierung", {"en": "Voice isolation", "fr": "Isolation de la voix", "es": "Aislamiento de voz", "it": "Isolamento vocale", "pl": "Izolacja głosu"}),
    ("Aufgenommen wird nur, solange du die Taste hältst. Sprachisolierung filtert Hintergrundgeräusche (z. B. Fernseher) und gleicht die Lautstärke an — bei sehr ruhiger Umgebung kannst du sie ausschalten.",
     {"en": "Recording happens only while you hold the key. Voice isolation filters background noise (e.g. a TV) and levels the volume — you can turn it off in a very quiet room.",
      "fr": "L'enregistrement n'a lieu que tant que tu maintiens la touche. L'isolation de la voix filtre les bruits de fond (p. ex. une télé) et égalise le volume — tu peux la désactiver dans un environnement très calme.",
      "es": "La grabación solo ocurre mientras mantienes la tecla. El aislamiento de voz filtra el ruido de fondo (p. ej. un televisor) y nivela el volumen — puedes desactivarlo en un entorno muy silencioso.",
      "it": "La registrazione avviene solo mentre tieni premuto il tasto. L'isolamento vocale filtra i rumori di fondo (es. una TV) e livella il volume — puoi disattivarlo in un ambiente molto silenzioso.",
      "pl": "Nagrywanie odbywa się tylko, gdy trzymasz klawisz. Izolacja głosu filtruje szumy tła (np. telewizor) i wyrównuje głośność — w bardzo cichym otoczeniu możesz ją wyłączyć."}),
